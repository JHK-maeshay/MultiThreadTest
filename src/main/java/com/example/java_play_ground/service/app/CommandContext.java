...
import com.example.java_play_ground.service.components.*;
import com.example.java_play_ground.service.controller.*;
...
public class CommandContext {
    ...
    private final List<Linker> controllers = new ArrayList<>();
 ...
 // Controller 관련 메서드
    public void addController(Linker controller) {
